#class method : the method which can be called without creating instance object. int1 = Item()
...
class Item:
    ...
    def __init__(self, name: str, price: float, quantity=0):
        ...
        Item.instance.append(
            self)  # here the append happening whatever is defined in the default __repr__() method. i,e. return f" <__main__.Item object at 0x0000020125ED30A0> "
